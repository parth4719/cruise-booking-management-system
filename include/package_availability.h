 ...
 *
 * @details Function takes the selected cruise type, number of passengers and total numbers of seats in
 *          all the cruise as input, and checks the seat availability for number of passengers provided
 *          in the particular selected cruise type.
 *
 *
