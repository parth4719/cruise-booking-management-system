 ...
 *             the fares and discounts for different types of rooms as input and applies discounts for specially abled,
 *             different age groups of passengers and group size to calculate the total fare of that booking
 *
...
float fare_calculation(int no_of_pass, int package_fare, int cruise_selected, int suite_length, int *room_booked) {
    ...
    */
    ...
    /**
    * Opening file to read the additional fares and discounts applicable for different suites and
    * storing data read from each column as different arrays
    */
